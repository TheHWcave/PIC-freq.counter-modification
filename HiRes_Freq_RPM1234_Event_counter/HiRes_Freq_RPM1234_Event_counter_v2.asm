...
RANGE_DET_LOOPS equ  CLOCK/(.30*CYCLES) ; number of gate-time loops to detect the MEASURING RANGE
	   ...
	   ; 2020-02-20 TheHWcave: shortened range 3 to use the prescaler earlier to avoide the 120ns problem
           ;[(3)    55..2047       ..  3.9 MHz   1       1/4 second  X.XXXXMHz,    4 Hz  (last digit steps by 1)] old
	   ; (3)    55..511        ..983.1 KHz   1       1/4 second  X.XXXXMHz,    4 Hz  (last digit steps by 1)
	   ; (4)   512..2047       ..  3.9 MHz   2       1/4 second  X.XXXXMHz,    8 Hz  (last digit steps by 1)
          ...
          goto  Range4
          btfsc freq_ml,2      ; bit 10 set (>=1024) ->  2021-02-20 TheHWcave was range 3 now 4
          goto  Range4
          btfsc freq_ml,1      ; bit 9 set (>=512)   ->  2021-02-20 TheHWcave was range 3 now 4
          goto  Range4
